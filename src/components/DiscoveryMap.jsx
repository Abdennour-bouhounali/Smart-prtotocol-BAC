    ...
    <div style={CONTAINER_STYLE}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '15px' }}>
            <div style={{
                ...
                fontSize: '11pt', fontWeight: 'bold', color: '#991b1b'
            }}>1</div>
        ...
        <div style={{ paddingRight: '10px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px', padding: '6px 0' }}>
                ...
                <div style={{ direction: 'ltr', background: '#fffbeb', padding: '3px 8px', borderRadius: '4px', border: '1px dashed #f59e0b', fontSize: '11pt' }}>
...
export const DiscoveryInventory = () => (
    <div style={CONTAINER_STYLE}>
        ...
        <div style={{
            ...
            padding: "5px 14px", fontSize: '11pt', color: "#0369a1",
